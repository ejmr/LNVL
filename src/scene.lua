...
-- story reaches the instruction ultimtely created by changeTo().  The
-- function will receive one argument: the scene which contains it.
-- The function must return a string, which must be the name of a
