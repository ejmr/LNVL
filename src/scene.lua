...
--
-- N.B. The 'name' parameter in this function refers to the variable
-- name for the Script object in the dialog script.  In other words,
-- 'name' must be a valid key for the LNVL.ScriptEnvironment table and
-- must point to a Scene object.  See the implementation for the
-- 'set-scene' instruction for more details, as that is the
-- instruction generated by the 'change-scene' opcode.
