...
function MenuChoice:new(properties)
    ...
    LNVL.Debug.Log.assert(choice.label ~= nil,
                          "MenuChoice must have a label.", "warn")
    LNVL.Debug.Log.assert(type(choice.action) == "function",
                          "MenuChoice action must be a function.", "warn")
